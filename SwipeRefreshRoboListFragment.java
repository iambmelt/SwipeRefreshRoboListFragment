 ...
 * 
 * Adapted from SwipeRefreshLayout
...
/**
 * Subclass of {@link RoboListFragment} which provides automatic support for
 * providing the 'swipe-to-refresh' UX gesture by wrapping the the content view
 * in a {@link android.support.v4.widget.SwipeRefreshLayout}.
 */
public abstract class SwipeRefreshRoboListFragment extends RoboListFragment {
    ...
    public final View onCreateView(LayoutInflater inflater,
        ...
        final View listFragmentView =
                onSubCreateView(inflater, container, savedInstanceState);

        // Now create a SwipeRefreshLayout to wrap the fragment's content view
        mSwipeRefreshLayout =
                new ListFragmentSwipeRefreshLayout(container.getContext());
    ...
    /**
     * Subclasses of SwipeRefreshRoboListFragment should inflate their custom
     * views into this method as they would for
     ...
     */
    protected abstract View onSubCreateView(LayoutInflater inflater,
            ViewGroup container, Bundle savedInstanceState);

    /**
     * Set the
     * {@link android.support.v4.widget.SwipeRefreshLayout.OnRefreshListener} to
     * listen for
     * initiated refreshes.
     * 
    ...
    /**
     * Returns whether the {@link android.support.v4.widget.SwipeRefreshLayout}
     * is currently
     * refreshing or not.
     * 
    ...
    public void setColorScheme(int colorRes1, int colorRes2, int colorRes3,
            int colorRes4) {
        mSwipeRefreshLayout.setColorScheme(colorRes1, colorRes2, colorRes3,
                colorRes4);
    }
    ...
    /**
     * Sub-class of {@link android.support.v4.widget.SwipeRefreshLayout} for use
     * in this {@link android.support.v4.app.ListFragment}. The reason that this
     * is needed is because {@link android.support.v4.widget.SwipeRefreshLayout}
     * only supports a single child, which it
     * expects to be the one which triggers refreshes. In our case the layout's
     ...
     * {@link android.widget.ListView} we need to override the default behavior
     * and properly signal when a gesture is possible. This is done by
